...
public class PaymentPage extends BrowserUtility{
	...
	private static final By ALERT_SUCCESSFUL_MESSAGE_LOCATOR=By.xpath("//p[contains(@class,'alert-success')]");
	...
	public String makePaymentByWire() {
		...
		return getVisibleText(ALERT_SUCCESSFUL_MESSAGE_LOCATOR);
	}
